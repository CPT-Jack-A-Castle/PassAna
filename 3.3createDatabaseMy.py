...
def split_train_and_test():
    ...
    save_pkl('./dataset/context_train_data.pkl', X)
    save_pkl('./dataset/context_train_label.pkl', Y)

    save_pkl('./dataset/context_test_data.pkl', X_t)
    save_pkl('./dataset/context_test_label.pkl', Y_t)
